        ...
        $advisors =
            [
                [
                    ...
                    'photo_url' => asset('assets/images/finance-advisor(1).png'),
                    'category' => 'finance',
                ...
                [
                    ...
                    'photo_url' => asset('assets/images/finance-advisor(2).png'), // Replace with the actual image file name
                    'category' => 'finance',
                ...
                [
                    ...
                    'photo_url' => asset('assets/images/finance-advisor(3).png'), // Replace with the actual image file name
                    'category' => 'finance',
                ...
                [
                    ...
                    'photo_url' => asset('assets/images/marketing-advisor(1).png'),
                    'category' => 'marketing',
                ...
                [
                    ...
                    'photo_url' => asset('assets/images/marketing-advisor(2).png'),
                    'category' => 'marketing',
                ...
                [
                    ...
                    'photo_url' => asset('assets/images/marketing-advisor(3).png'),
                    'category' => 'marketing',
                    'expertise' => 'Animator',
                ],
                [
                    ...
                    'photo_url' => asset('assets/images/legal-advisor(1).png'),
                    'category' => 'legal',
                ...
                [
                    ...
                    'photo_url' => asset('assets/images/legal-advisor(2).png'),
                    'category' => 'legal',
                ...
                [
                    ...
                    'photo_url' => asset('assets/images/legal-advisor(3).png'),
                    'category' => 'legal',
