...
class StartupEditProfile extends ConsumerStatefulWidget {
  const StartupEditProfile({super.key});

  @override
  ConsumerState<StartupEditProfile> createState() => _StartupEditProfileState();
}

class _StartupEditProfileState extends ConsumerState<StartupEditProfile> {
